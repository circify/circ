...
// Sum-check: shows that evals of sume poly of a mult subgroup and add them, then you get some
//            value
// Lin-check: uses sum check
// row-check: z_a * z_b - z_c = 0
// w? : 
//
// 1. There some unknown values -> z01 ... z0n, alpha, z11 ... z1m (how are z1js evaluated from
//    z0jlka;jfd
...
impl<F: PrimeField> AHPForR1CS<F> {
    ...
    pub fn prover_first_round<'a, R: RngCore>(
        ...
        // interleaving w and x? indices for x are a multiplicative subgroup of H
