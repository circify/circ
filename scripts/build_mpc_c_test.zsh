...
./target/release/examples/precomp scripts/aby_tests/tests/playground_c_plaintext_ir.txt scripts/aby_tests/test_inputs/playground.txt scripts/aby_tests/tests/playground_precompute_result.txt -f
...
# ../ABY/build/bin/aby_interpreter -M mpc -R 0 -b scripts/aby_tests/tests/playground_c_bytecode.txt -t scripts/aby_tests/tests/playground_precompute_result.txt -s scripts/aby_tests/tests/playground_c_share_map.txt
