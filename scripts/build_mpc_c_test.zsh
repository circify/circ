...
function mpc_test_glp {
    parties=$1
    cpath=$2
    RUST_BACKTRACE=1 measure_time $BIN --parties $parties $cpath mpc --cost-model "hycc" --selection-scheme "glp"
}

function mpc_test_tlp {
    parties=$1
    cpath=$2
    RUST_BACKTRACE=1 measure_time $BIN --parties $parties $cpath mpc --cost-model "hycc" --selection-scheme "tlp"
}

function mpc_test_css {
    parties=$1
    cpath=$2
    RUST_BACKTRACE=1 measure_time $BIN --parties $parties $cpath mpc --cost-model "hycc" --selection-scheme "css"
}
...
# mpc_test 2 ./examples/C/mpc/benchmarks/gauss/2pc_gauss.c
# mpc_test 2 ./examples/C/mpc/benchmarks/mnist/2pc_mnist.c
